...
@Component({
  selector: 'app-schedule-appointment-modal-host',
  templateUrl: './schedule-appointment-modal-host.component.html',
  styleUrls: ['./schedule-appointment-modal-host.component.scss']
})
export class ScheduleAppointmentModalHostComponent implements OnInit {

  currentDialog: MatDialogRef<ScheduleAppointmentModalComponent> = null;
  ...
  constructor(
    ...
    .subscribe(params => {
      ...
      this.currentDialog = dialog.open(ScheduleAppointmentModalComponent, {
         data: {
